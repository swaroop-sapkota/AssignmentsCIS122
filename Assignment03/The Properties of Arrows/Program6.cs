...
class Program
{
    static void Main()
    {
        ...
        Console.WriteLine("Choose a fletching type: (1) Plastic, (2) Turkey Feather, (3) Goose Feathers");
        ...
        Arrow3 arrow = new Arrow3(selectedArrow, selectedFletching, shaftLength);
